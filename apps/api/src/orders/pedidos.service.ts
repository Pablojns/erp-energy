...
export class PedidosService {
  ...
  /**
   * Fonte única da listagem, inclusive da aba Separação: `OrderService.buildWhere`
   * já trata `workspace=separation` (data de corte + status) e aplica TODOS os
   * filtros (transportadora, ponto de descarga, recebedor, datas, busca livre).
   * O caminho paralelo que existia aqui só conhecia busca/filtro por campo e
   * descartava silenciosamente os demais — era o motivo de selecionar um ponto
   * de descarga e a lista continuar mostrando tudo.
   */
