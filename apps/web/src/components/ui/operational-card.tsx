...
export function OperationalCard({
  ...
  return (
    <GlassCard
      hover
      className="border border-[var(--border-color)] bg-[var(--bg-card)] p-5 shadow-sm transition duration-300 hover:-translate-y-0.5"
    ...
    >
      ...
      <p className="mt-3 text-2xl font-bold tracking-tight text-[var(--text-primary)] tabular-nums">
        {value}
      </p>
