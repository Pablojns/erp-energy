  ...
  if (variant === 'icon') {
    return (
      <button
        ...
        disabled={isPending}
        className="erp-icon-btn erp-focus-ring flex h-10 w-10 items-center justify-center text-erp-fg-muted transition hover:border-rose-400/35 hover:bg-rose-500/10 hover:text-rose-600 disabled:cursor-not-allowed disabled:opacity-60"
