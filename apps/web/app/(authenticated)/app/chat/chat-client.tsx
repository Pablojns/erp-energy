      ...
      <section className="flex min-w-0 flex-1 flex-col">
        {selectedRoom ? (
            ...
            <header className="shrink-0 border-b border-[var(--erp-border)] px-4 py-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-500">Conversa interna</p>
                </div>
              </div>
            </header>
                ...
                messages.map((message) => {
                  ...
                  return (
                    ...
                    >
                      {!isMine ? (
                        <span
                          className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-zinc-700 text-[10px] font-semibold text-zinc-100"
            ...
            >
              <div className="flex items-end gap-2">
                <textarea
                  ...
                  disabled={sending}
                  className="erp-scrollbar max-h-28 min-h-[42px] flex-1 resize-none rounded-xl border border-white/10 bg-[#0d1320] px-3 py-2.5 text-sm text-zinc-100 outline-none placeholder:text-zinc-500 focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20 disabled:opacity-60"
                />
                <button
                  type="submit"
          ...
          <div className="flex flex-1 flex-col items-center justify-center gap-2 px-6 text-center">
            <MessageSquarePlus className="h-10 w-10 text-zinc-600" />
